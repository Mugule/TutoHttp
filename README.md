...
Hi everyone, welcome to this tutorial where you will learn the very basic of HTTP Request and how to setup a external database with Supabase. I did the Godot project on 4.6.2 but i'm pretty sure that you can load this on all Godot 4.+ editors. The tutorial will be in 3 parts :
* Some theory
* Setup Supabase
* Godot HTTP playground

Bonus : Little applications idea with that
...
For this example I choose Supabase but the tool doesn't really matter. You can have Firebase, Back4App, Appwrite, homemade server with FastAPI or whatever. The logic is almost the same. I let you create an account.

### Create project and a table
